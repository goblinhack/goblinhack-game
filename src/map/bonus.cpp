...
static int GH_MAP_WIDTH                 = 60;
static int GH_MAP_HEIGHT                = 60;
...
// Grow our cells
//
void gh_maze::bonus_generation (void)
{
    GH_FUNCTION()
...
//
// Generate a bonus level!
//
void gh_maze::make_bonus (void)
{
    GH_FUNCTION()
...
// Generate a maze!
//
void gh_maze::bonus_gen (void)
{
    GH_FUNCTION()

    GH_LOG("Generate new bonus level");
