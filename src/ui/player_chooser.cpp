/*
    ...
    $Id: player_chooser.cpp 276 2006-11-20 21:16:05Z goblinhack $
*/
...
static string gh_ui_display_player_choosers (gh_game *game,
                                             vector<string> files,
                                             size_t base,
                                             size_t at,
                                             const size_t how_many)
{
    ...
    font1->printat(2, "Thy Previous Mortals!");
...
void gh_myscreen::display (void)
{
    ...
    chose = gh_ui_display_player_choosers(game, files, base, at, how_many);
...
gh_event_ret gh_ui_new_player_chooser_loop (gh_game *game)
{
    GH_FUNCTION()
    ...
    screen.how_many = 10;
    screen.chose = "";
    screen.files = gh_global::listdir_recursive(screen.playerdir, "");
