/*
    ...
    $Id: player_class_chooser.cpp 276 2006-11-20 21:16:05Z goblinhack $
*/
...
static string gh_ui_display_player_class_choosers (gh_game *game,
                                             vector<string> files,
                                             size_t base,
                                             size_t at,
                                             const size_t how_many)
{
    ...
    if (!files.size()) {
        font1->printat(2, "No Mortals!");
        return ("");
    }

    font1->printat(2, "Choose Thy Mortal!");
    ...
    while (f != files.end()) {
        ...
        //
        gh_thing *t = gh_thing::find("hero/" + a_filename, false /* error */);
        if (t) {
...
void gh_myscreen::display (void)
{
    ...
    chose = gh_ui_display_player_class_choosers(game, files, base, at, how_many);
...
gh_event_ret gh_ui_new_player_class_chooser_loop (gh_game *game)
{
    ...
    screen.playerdir = gh_global::locatedir("things/hero");
